...
//    @Scheduled(fixedDelayString = "#{@getFixedDelay}")
    public void runJob() throws JobInstanceAlreadyCompleteException, JobExecutionAlreadyRunningException,
        ...
        JobParameters jobParameters = schedulerDao.getJobParameterFromTheLastExecutionAtNonOverrideModeRegardlessOfStatus("job");
        int count;
        ...
        this.jobOperator.start("job", "name=" + count);
    }
